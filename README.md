...
To update the database use this command from the Web project folder (replace `OrderApp` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../OrderApp.Infrastructure/OrderApp.Infrastructure.csproj -s OrderApp.Web.csproj
```
